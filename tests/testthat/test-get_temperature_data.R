testthat::test_that("errors", {
  ...
  testthat::expect_error(
    get_temperature_data(x = x, country = country, admin_lvl = admin_lvl, endDate = endDate),
    "Dates not provided."
  )
  testthat::expect_error(
    get_temperature_data(x = x, country = country, admin_lvl = admin_lvl, startDate = startDate),
    "Dates not provided."
  )
  testthat::expect_error(
    get_temperature_data(x = x, country = country, admin_lvl = admin_lvl, startDate = "2022-02-01", endDate = "2022-01-01"),
